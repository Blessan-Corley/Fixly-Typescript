        ...
        <div className="container mx-auto max-w-4xl text-center">
          <motion.div className="glass-card p-8 rounded-2xl mb-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">We're Hiring Amazing People</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              {[
                ...
                <motion.div key={i} className="p-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }}>
                  <perk.icon className="w-8 h-8 text-slate-600 mx-auto mb-2" />
          ...
          <motion.div className="glass-card p-8 rounded-xl" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Current Openings</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex justify-between items-center p-4 glass rounded-lg hover-lift-subtle">
                  ...
                  <button className="px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 btn-hover">Apply</button>
                </div>
              ))}
            </div>
            <p className="text-slate-600 text-center mt-6">Don't see your role? Send us your resume anyway at careers@fixly.com</p>
          </motion.div>
        </div>
      </section>
    </PageLayout>
